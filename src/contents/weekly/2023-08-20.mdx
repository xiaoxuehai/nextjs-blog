...
> TypeScript包体积在5.3版本会有所减小

在上周`TS`发布`5.2 RC`版本，typescript开发者Jake Bailey表示在未来`5.3`版本会比`5.2`包体积小`20%`

> Bun 1.0

Bun作为近两年新推出的JavaScript运行时，经过不断更新迭代，将在2023年9月7日迎来`1.0`版本
